...
ncRNAPathway<-genePathwayEnricher(gene = brain_disorder_ncRNA[1:100,], org_assembly='hg19', pathwayType = 1 , isTADSearch = TRUE,TAD = tad_hg19, genetype = 'Ensembl_gene', min=2,pAdjust = "none")
```
