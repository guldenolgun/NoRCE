...
mirGO<-mirnaGOEnricher(gene = brain_mirna, org_assembly='hg19', near=TRUE, isTADSearch = TRUE, TAD = tad_hg19, cellline = c('A549', 'AdrenalGland'),pAdjust = "none")
...
```{r, Convert TAD regions to bed format, eval=TRUE}
...
ncGO<-geneGOEnricher(gene = brain_disorder_ncRNA[1:100,], org_assembly='hg19', near=TRUE, genetype = 'Ensembl_gene', searchRegion = "exon", isTADSearch = TRUE, TAD = tad_custom, pAdjust = "none")
...
ncRNAPathway<-genePathwayEnricher(gene = brain_disorder_ncRNA[1:100,], org_assembly='hg19', pathwayType = 'kegg', isTADSearch = TRUE,TAD = tad_hg19, genetype = 'Ensembl_gene', min=2,pAdjust = "none")
```
